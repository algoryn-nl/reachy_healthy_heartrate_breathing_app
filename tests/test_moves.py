...
def _make_running_manager() -> MovementManager:
    """Create and start a MovementManager with a mocked robot."""
    mgr = _make_manager()
    mgr.start()
...
class TestConcurrentQueueMove:
    ...
    def test_concurrent_queue_move_all_enqueued(self) -> None:
    ...
    def test_concurrent_queue_move_no_data_corruption(self) -> None:
...
class TestConcurrentClearAndQueue:
    ...
    def test_clear_and_queue_interleaved(self) -> None:
    ...
    def test_clear_and_queue_with_get_status(self) -> None:
...
class TestConcurrentSecondaryOffsets:
    ...
    def test_concurrent_speech_offsets(self) -> None:
    ...
    def test_concurrent_face_tracking_offsets(self) -> None:
    ...
    def test_concurrent_speech_and_face_offsets(self) -> None:
...
class TestRapidStartStopStress:
    ...
    def test_concurrent_rapid_start_stop(self) -> None:
...
class TestConcurrentListening:
    ...
    def test_concurrent_listening_toggles(self) -> None:
    ...
    def test_listening_and_queue_move_concurrent(self) -> None:
...
class TestIsIdleConcurrent:
    ...
    def test_is_idle_concurrent_reads(self) -> None:
