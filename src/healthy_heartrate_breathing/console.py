...
from healthy_heartrate_breathing.config import LOCKED_PROFILE, config
from healthy_heartrate_breathing.openai_realtime import OpenaiRealtimeHandler
from healthy_heartrate_breathing.headless_personality_ui import mount_personality_routes
    ...
    def _persist_api_key(self, key: str) -> None:
        ...
        - Writes/updates ``<instance_path>/.env``:
          ...
          * Else, copies template from ``<instance_path>/.env.example`` when present,
            ...
            ``healthy_heartrate_breathing/.env.example``.
