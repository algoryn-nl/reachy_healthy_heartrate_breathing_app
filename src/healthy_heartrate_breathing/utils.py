...
from healthy_heartrate_breathing.camera_worker import CameraWorker
    ...
    if not args.no_camera:
        ...
        if args.head_tracker is not None:
            if args.head_tracker == "yolo":
                from healthy_heartrate_breathing.vision.yolo_head_tracker import HeadTracker
        ...
        if args.local_vision:
            try:
                from healthy_heartrate_breathing.vision.processors import initialize_vision_manager
