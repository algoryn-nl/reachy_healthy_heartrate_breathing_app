...
- [x] **PY-FEAT-2**: Health trend analysis — two-tier vitals aggregation (hourly/daily), TrendAnalyzer with statistical + absolute anomaly detection, sparse insight injection into mmWave results, `vitals_trends` on-demand tool, dashboard trends panel (daily bar chart, stats cards, insights list), `/api/vitals/trends` REST endpoint, `trend_insights` persistence table, schema v2 migration; 9 new env vars; 43 new tests (551 total; 2026-03-05)
